        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Rate = table.Column<string>(type: "nvarchar(1)", maxLength: 1, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    duration = table.Column<string>(type: "nvarchar(2)", maxLength: 2, nullable: false),
                    ClinicId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Schadules", x => x.ID);
                    table.ForeignKey(
                        name: "FK_Schadules_Clinics_ClinicId",
                        column: x => x.ClinicId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DoctorId = table.Column<int>(type: "int", nullable: true),
                    PatientId = table.Column<int>(type: "int", nullable: true),
                    schaduleId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "ID");
                    table.ForeignKey(
                        name: "FK_Appointments_Schadules_schaduleId",
                        column: x => x.schaduleId,
                        principalTable: "Schadules",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Appointments_schaduleId",
                table: "Appointments",
                column: "schaduleId");
